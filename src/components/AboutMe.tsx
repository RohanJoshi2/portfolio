export function AboutMe() {
    return (
        <section className="flex min-h-0 flex-col gap-y-3 bg-black">
          ...
          <p className="text-pretty text-sm text-muted-foreground print:text-[12px]">
            Hi, I am a 10th grader at <span className="hover:underline"><a href="https://dhs.dublinusd.org/" target="_blank" rel="noopener noreferrer">Dublin High School</a></span>
            . My coding journey started at a very young age, when I started using scratch in around first grade, which allowed me to easily make my ideas real. Later on in 2017 my parents enrolled me into <span className="hover:underline"><a href="https://www.hackingtons.com/" target="_blank" rel="noopener noreferrer">Hackingtons</a></span>
