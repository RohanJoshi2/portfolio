      ...
      <div className="z-10 w-full max-w-5xl items-center font-mono text-xl justify-center flex flex-col">
        ...
        <p className="max-w-md items-center text-pretty text-xs text-muted-foreground">
          ...
          <section className="flex min-h-0 flex-col gap-y-3">
            ...
            <p className="text-pretty text-sm text-muted-foreground print:text-[12px]">Currently, I'm a 9th grader @ <span className="hover:underline"><a href="https://dhs.dublinusd.org/" target="_blank" rel="noopener noreferrer">Dublin High School</a></span>
            .
            </p></section>
      </div>
    </main>
